package hebaja.com.example.agenda.ui;
...
import hebaja.com.example.agenda.asynctask.BuscaAlunosTask;
import hebaja.com.example.agenda.asynctask.RemoveAlunoTask;
...
public class ListaAlunosView {
    ...
    public void confirmaRemocao(@NonNull final MenuItem item) {
        new AlertDialog.Builder(context)
                ...
                .setMessage("Quer mesmo remover o aluno?")
